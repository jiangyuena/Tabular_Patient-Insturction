...
class TextOnlyDataset(Dataset):
    ...
    def __getitem__(self, index: int):
        ...
        tabular_text=data_row["tabular_text"]
        ...
        tabular_text_encoding = self.tokenizer(
            tabular_text,
            return_attention_mask=True,
            add_special_tokens=False,
            return_tensors="pt",
        ...
        return dict(
            ...
            tabular_text_input_ids=tabular_text_encoding["input_ids"].flatten(),
            source_text_attention_mask=source_text_encoding["attention_mask"].flatten(),
            tabular_text_attention_mask=tabular_text_encoding["attention_mask"].flatten(),
